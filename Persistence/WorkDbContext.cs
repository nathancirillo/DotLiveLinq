    ...
    public class WorkDbContext
    {
        ...
        public WorkDbContext()
        {
            Employees = new List<Employee>
            {
                ...
                new Employee(6, "Luana","Sales",14_243m, new List<Invoice>{new Invoice(6,"06/2023",6,14_243m), new Invoice(7,"05/2023",6,14_243m)}),
                new Employee(7, "Priscila", "TI", 8_240m, new List<Invoice>{new Invoice(8,"06/2023",7,8_240m)}),
